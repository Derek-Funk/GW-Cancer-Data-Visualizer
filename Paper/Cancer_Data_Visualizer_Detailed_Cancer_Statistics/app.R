...
#command to deploy app: deployApp(appDir = "C:\\Users\\derek.funk\\Documents\\MSDS\\Capstone\\Paper\\Cancer_Data_Visualizer_Detailed_Cancer_Statistics", account = "derek-funk")
            ...
            #                             ),
                                        # tabsetPanel(id = "tabs",
                                                    ...
                                                    #          br(),
                                                             fluidRow(
                                                               column(width = 2,
                                                                      box(title = tags$strong("Select Chart"), width = 12, height = 150,
