...
#command to deploy app: deployApp(appDir = "C:\\Users\\derek.funk\\Documents\\MSDS\\Capstone\\Paper\\Cancer_Data_Visualizer_Risk_and_Protective_Factors", account = "derek-funk")
            ...
            #                             ),
                                        # tabsetPanel(id = "tabs",
                                                    ...
                                                    tabPanel(title = "RISK AND PROTECTIVE FACTORS",
                                                             ...
                                                             fluidRow(
                                                               column(width = 2,
                                                                      box(title = tags$strong("Select Chart"), width = 12, height = 252,
