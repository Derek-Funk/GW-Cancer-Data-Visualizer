...
# calculate DMV cancer rates
#####

finalDataFrame_nonCancer = read.csv(file = "masterDataFile_nonCancer_countyWard.csv")
finalDataFrame_nonCancer %>%
  filter(variable == "population", region >= 9)
