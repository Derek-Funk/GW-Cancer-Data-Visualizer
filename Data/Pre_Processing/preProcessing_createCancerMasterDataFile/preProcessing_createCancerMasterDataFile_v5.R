...
years = 2015:2016
regionsWithFipsCodes = c(11001, # DC
                         24017, 24033, 24031, # Maryland
                         51013, 51059, 51107, 51153, # Virginia counties
                         51510, 51600, 51610, 51683, 51685) # Virginia independent cities
regions = c(0, # DMV Catchment Area
            1:8, # DC wards
            regionsWithFipsCodes)
regionMapping = list(
  originalNames = c("District of Columbia",
                    "MD: Charles County (24017)", "MD: Prince Georges County (24033)", "MD: Montgomery County (24031)",
                    "VA: Arlington County (51013) - 1980+", "VA: Fairfax County (51059) - 1980+", "VA: Loudoun County (51107)", "VA: Prince William County (51153) - 1982+",
                    "VA: Alexandria City (51510) - 1980+", "VA: Fairfax City (51600) - 1980+", "VA: Falls Church City (51610) - 1980+", "VA: Manassas City (51683) - 1982+", "VA: Manassas Park City (51685) - 1982+"
                    ),
  newNames = regionsWithFipsCodes
)
...
for(i in 1:numberOfRows) {
  ...
  } else if(!(finalDataFrame$region[i] %in% 0:8)) {
    # populate rates for counties, independent cities, and DC
