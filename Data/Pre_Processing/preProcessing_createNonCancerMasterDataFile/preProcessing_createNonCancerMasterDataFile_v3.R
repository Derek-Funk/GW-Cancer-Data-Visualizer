  ...
  if(any(
    ...
    variableGroupIndex = (
      if(finalDataFrame$variable[i] %in% c("education","foreign-born","language")) {
        # social
        1
      } else if(finalDataFrame$variable[i] %in% c("medianHouseholdIncome","employment","healthInsuranceCoverage")) {
        # economic
        2
...
for(i in 1:numberOfRows) {
  if(any(
    ...
    if(regionLevel == "ward") {
      if(variable %in% c("medianAge","medianHouseholdIncome","unemploymentRate")) {
