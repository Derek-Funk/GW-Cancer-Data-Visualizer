...
# populating VA/MD counties and independent cities from Census Bureau API and EPA API
#####
...
# calculating DMV Catchment Area values (region 0)
#####
...
setwd("C:\\Users\\derek.funk\\Documents\\MSDS\\Capstone\\Cancer_Data_Visualizer\\Data\\Pre_Processing\\preProcessing_createNonCancerMasterDataFile")
source(file = "countyHealthRankings/countyHealthRankings_v4.R")
